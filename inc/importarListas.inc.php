		      ...
		      $datostemp = pg_query($con,$querytemp);
		       ...
		       if (pg_num_rows($datostemp)>0) {
	                 ...
	                 if(is_null($datosdec[0]))//nocuenta
	                    $columna1=0; elseif (preg_match("/[\d.]+/",$datosdec[0]))
						    $columna1=2; else  $columna1=3; 
					 
	                 if(is_null($datosdec[1])) //nom_alu
	                    $columna2=0; /* elseif (is_string($datosdec[1]))
						             $columna2=3; else $columna2=2; */
				     if(is_null($datosdec[2])) //nom_pat_alu
	                    $columna3=0; elseif (is_string($datosdec[2]))
						             $columna3=3; else $columna3=2;
	                 if(is_null($datosdec[3])) //nom_mat_alu
	                    $columna4=0; elseif (is_string($datosdec[3]))
						             $columna4=3; else $columna4=2;
					 if(is_null($datosdec[4])) //nomprof
	                    $columna5=0; elseif (is_string($datosdec[4]))
						             $columna5=3; else $columna5=2;
	                 if(is_null($datosdec[5])) //nom_pat_prof
	                    $columna6=0; elseif (is_string($datosdec[5]))
						             $columna6=3; else $columna6=2;
				     if(is_null($datosdec[6])) //nom_pat_prof
	                    $columna7=0; elseif (is_string($datosdec[6]))
						             $columna7=3;  else $columna7=2;
	                 if(is_null($datosdec[7]))
					    $columna8=0; elseif (preg_match("/[\d.]+/",$datosdec[7])) 
						        $columna8=2; else $columna8=3;  
	                 if(is_null($datosdec[8]))
					    $columna9=0; elseif (preg_match("/[\d.]+/",$datosdec[8])) 
						        $columna9=2; else $columna9=3; 
	                 if(is_null($datosdec[9])) //semestre
	                    $columna10=0; elseif (is_string($datosdec[9]))
						             $columna10=3;	else $columna10=2; 
				     if(is_null($datosdec[10])) //salon
	                    $columna11=0; elseif (is_string($datosdec[10]))
						             $columna11=3; 	 else $columna11=2;
	                 if(is_null($datosdec[11])) //horaini
	                    $columna12=0; elseif (is_string($datosdec[11]))
						             $columna12=3;  else $columna12=2;
					 if(is_null($datosdec[12])) //horafin
	                    $columna13=0; elseif (is_string($datosdec[12]))
						             $columna13=3;  else $columna13=2;
	                 if(is_null($datosdec[13])) //dia
	                    $columna14=0; elseif (preg_match("/[\d.]+/",$datosdec[13])) 
						        $columna14=2; else $columna14=3; 
